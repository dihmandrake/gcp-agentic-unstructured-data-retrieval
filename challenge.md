...
Welcome to the challenge. You are not just tweaking prompts; you are re-engineering the system. Your success will be evaluated on three pillars:
...
This is the advanced "Boss Level." A single agent is often overwhelmed. We want you to design a **Multi-Agent System** where specialized agents collaborate to solve a problem.
